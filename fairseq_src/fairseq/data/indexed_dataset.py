...
def make_dataset(path, impl, fix_lua_indexing=False, dictionary=None):
    ...
    if impl == "raw" and IndexedRawTextDataset.exists(path):
        ...
        print("MMapIndexedDataset:path", path)
...
class MMapIndexedDataset(torch.utils.data.Dataset):
    class Index:
        ...
        def __init__(self, path):
            ...
            print("Index._bin_buffer_mmap:", self._bin_buffer_mmap)
            ...
            print("Index._sizes:", self._sizes)
            ...
            print("Index._pointers:", self._pointers)
    ...
    def _do_init(self, path):
        ...
        print("MMapIndexedDataset: index_file_path:", index_file_path(self._path))
        self._index = self.Index(index_file_path(self._path))

        _warmup_mmap_file(data_file_path(self._path))

        print("MMapIndexedDataset: data_file_path:", data_file_path(self._path))
        self._bin_buffer_mmap = np.memmap(
            data_file_path(self._path), mode="r", order="C"
        )
        print("MMapIndexedDataset: _bin_buffer_mmap:", self._bin_buffer_mmap)

        self._bin_buffer = memoryview(self._bin_buffer_mmap)
        print("MMapIndexedDataset: _bin_buffer:", self._bin_buffer)
        print(len(self._bin_buffer.tolist()))
        print()
