...
class Trainer(object):
    ...
    def train_step(self, samples, raise_oom=False):
        ...
        for i, sample in enumerate(samples):  # delayed update loop
            ...
            # print("train_step: self.task:", self.task)
            # print("train_step: sample in samples:", i, sample)
            ...
            try:
                ...
                # print("trainer: logging_outputs:", logging_outputs, "\n")
                # breakpoint()
        ...
        if self._sync_stats():
            ...
            # print("trainer: logging_outputs_gathered:", logging_outputs)
        ...
        if not overflow or self.cfg.distributed_training.ddp_backend == "slow_mo":
            ...
            if self.tpu:
                ...
                # print("trainer: logging_output_reduced:", logging_output, "\n")
