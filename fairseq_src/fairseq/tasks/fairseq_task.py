...
class FairseqTask(object):
    ...
    def get_batch_iterator(
        ...
        print("get_batch_iterator: dataset:", dataset)
        print("get_batch_iterator: max_tokens:", max_tokens)
        print("get_batch_iterator: max_sentences:", max_sentences)
        ...
        print("get_batch_iterator: len(batch_sampler):", len(batch_sampler))
